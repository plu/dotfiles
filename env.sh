...
if [[ "$OS" == "Darwin" ]]; then
  ...
  export LSOPTIONS='-G'
  export PATH=/opt/go_appengine:/usr/local/mysql/bin:/usr/local/bin:/usr/local/share/git/contrib:/opt/appengine-java-sdk/bin:/Applications/VMware\ Fusion.app/Contents/Library:$PATH
